...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
![GitHub package.json version](https://img.shields.io/github/package-json/v/ayush461/BLOOD-BANK)
![GitHub last commit](https://img.shields.io/github/last-commit/ayush461/BLOOD-BANK)
![GitHub repo size](https://img.shields.io/github/repo-size/ayush461/BLOOD-BANK)
...
```bash
git clone https://github.com/ayush461/BLOOD-BANK
cd bloodbank-master
```
